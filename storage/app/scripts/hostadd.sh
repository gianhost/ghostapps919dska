    ...
    <body>
        <div class="flex-center position-ref full-height">
            <div class="content">
                ...
                <div class="links">
                    <a href="https://www.gianhost.com">Powered by www.gianhost.com</a>
                </div>
            </div>
        </div>
    </body>
...
sudo dos2unix $POOL
CUSTOM=/etc/nginx/gianhost/$USER_NAME.conf
...
DBNAME=$USER_NAME
DBUSER=$USER_NAME
/usr/bin/mysql -u gianhost -p$DBROOT <<EOF
...
sudo cp /gianhost/github /home/$USER_NAME/git/deploy
sudo cp /gianhost/github.pub /home/$USER_NAME/git/deploy.pub
sudo cp /gianhost/deploy.sh /home/$USER_NAME/git/deploy.sh
sudo rpl -q "###gianhost-USER###" "$USER_NAME" /home/$USER_NAME/git/deploy.sh
