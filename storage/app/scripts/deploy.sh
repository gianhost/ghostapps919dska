...
GITHUB="MarkosTech/ghostapps919dska.git" #Choose your Github private/public repo
BRANCH="master" #Choose your repository branch here

######### DO NOT CHANGE ANYTHING IN THIS AREA #########
SSH_KEY="/home/###gianhost-USER###/git/deploy"
WORK_TREE="/home/###gianhost-USER###/web"
GIT_DIR="/home/###gianhost-USER###/git/deploy.git"
chmod 600 $SSH_KEY
eval $(ssh-agent -s)
ssh-add $SSH_KEY
