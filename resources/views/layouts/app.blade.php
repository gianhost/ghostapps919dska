...
<head>
    <meta charset="utf-8">
    <title>{{ config('app.name', 'GIANHOST') }} | @yield('title')</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/">
                <img src="https://www.gianhost.com/banner.png" class="img-responsive sidebar-brand-text mx-3">
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" target="_blank" href="https://app.sh/docs/">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span><a href="https://www.gianhost.com" target="_blank"><b>www.gianhost.com</b></a></span>
                    </div>
                </div>
            </footer>
        </div>
