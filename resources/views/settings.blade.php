    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="/settings/import" method="POST">
                @csrf
                <div class="modal-header">
                    <h5 class="modal-title" id="importModalLabel">Import app migration</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-sm-12 text-center">
                            ...
                            <textarea name="appkey" class="form-group" style="width:100%;height:80px;"></textarea><br>
                            <b><i>All data in current app db will be delete!</b></i>
                            <div class="space"></div>
                        </div>
                    </div>
                    <div class="row">
...
<div class="modal fade" id="exportModal" tabindex="-1" role="dialog" aria-labelledby="exportModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exportModalLabel">Export app migration</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        This is your app migration key:<br>
                        <textarea name="appkey" class="form-group" style="width:100%;height:80px;" id="export-key" readonly>Hold on... app is generating a new migration key...</textarea><br>
                        <div class="space"></div>
                    </div>
                </div>
                <div class="row">
